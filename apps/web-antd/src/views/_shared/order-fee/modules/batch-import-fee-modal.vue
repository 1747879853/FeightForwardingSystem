...
const handleSearch = async () => {
  ...
  try {
    ...
    const res = await adapter.api.getTransportOrderFees(params);
...
const handleImport = async () => {
  ...
  try {
    ...
    const result = await adapter.api.importOrderFeesToTransportOrder(params);
