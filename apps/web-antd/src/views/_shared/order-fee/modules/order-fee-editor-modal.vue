...
const orderBaseData = ref<any>(null);
  ...
  return [
    {
      ...
      fieldName: 'feeCodeId',
      label: orderFeeDataT('feecodeName'),
      componentProps: {
    ...
    },
    {
      ...
      fieldName: 'industryCategory',
      label: clientDataT('industryCategories'),
      componentProps: {
        style: { width: '100%' },
      },
    },
    {
      ...
      fieldName: 'settlementId',
      label: orderFeeDataT('settlement'),
      componentProps: {
        placeholder: $t('ui.placeholder.select'),
        allowClear: true,
        selectedItems: toSelectedItems(
    ...
    },
    {
      ...
      label: orderFeeDataT('noTaxUnitPrice'),
      componentProps: {
        min: 0,
        precision: 4,
        disabled: true,
    ...
    },
    {
      ...
      label: orderFeeDataT('noTaxAmount'),
      componentProps: {
        min: 0,
        disabled: true,
        precision: 2,
