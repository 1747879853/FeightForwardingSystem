            ...
            <ClientSelect v-if="!record.industryCategory" :model-value="record.settlementId" class="w-full min-w-[90px]"
              ...
              <template v-else-if="column.key === 'unitPrice'">
                <InputNumber
                  ...
                  :placeholder="$t('seaImport.import.orderFee.unitPrice')"
                  class="w-full"
                  :min="0"
                  :precision="4"
                  :controls="false"
              ...
              <template v-else-if="column.key === 'amount'">
                <InputNumber
                  :value="record.amount"
                  :placeholder="$t('seaImport.import.orderFee.amount')"
                  class="w-full"
                  :min="0"
                  :controls="false"
                  :precision="2"
              ...
              <template v-else-if="column.key === 'quantity'">
                <InputNumber
                  ...
                  :placeholder="$t('seaImport.import.orderFee.quantity')"
                  class="w-full"
                  :min="0"
                  :controls="false"
                  :precision="2"
              ...
              <template v-else-if="column.key === 'taxRate'">
                <InputNumber
                  ...
                  :placeholder="$t('seaImport.import.orderFee.taxRate')"
                  class="w-full"
                  :min="0"
                  :controls="false"
                  :precision="4"
