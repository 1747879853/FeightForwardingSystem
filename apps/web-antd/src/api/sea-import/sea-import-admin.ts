import type { ClientAdminApi } from '#/api/sea-import/client-admin';
...
export namespace SeaImportAdminApi {
  ...
  export interface SeaImportEditDto {
    id: number | string;
    blType?: number;
    billType?: number;
    secondNotifierId?: number;
...
export const getSeaImportDetail = (id: string | string) => {
...
export const deleteSeaImport = (id: number) => {
