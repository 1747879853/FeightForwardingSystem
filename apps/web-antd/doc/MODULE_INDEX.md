...
| system | `/system/global-font` | 系统管理 | 统一前端页面与组件字体来源；hhyy/jiayue 走固定 OSS，jht 优先签名 URL 失败回退固定 OSS；本地 TTF 已移除且 SW 已停用。 | [全局字体配置](./modules/system/global-font.md) | 2026-06-02 |
