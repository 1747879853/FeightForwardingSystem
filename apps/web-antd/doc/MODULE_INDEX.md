...
| sea-exports | `/sea-exports/:id/edit` Tab「更改单」 | 操作管理 / 海运出口 | 更改单选择器+历史抽屉；订单信息顶部通铺；费用表复用 Handsontable，页签一次只显示应收或应付，保存只提交当前侧。 | [更改单](./modules/sea-exports/change-order.md) | 2026-09-09 |
