...
| fee-management | `/fee-management/invoice-application` | 费用管理 | 开票申请列表：检索、新建、双击编辑或查看、提交与撤销；申请时间筛选按自然日闭区间；编辑提交进查看、查看撤回进编辑。 | [开票申请列表](./modules/fee-management/invoice-application.md) | 2026-09-09 |
