...
| 跳转表单页保存后返回    | ✅ `onActivated`     |
| 切换到其他菜单再回来    | ✅ `onActivated`     |
| 关闭标签页后重新打开    | ✅ 重新挂载          |
| 其他用户修改数据        | ❌ 需手动刷新        |
...
| 日期 | 说明 |
| :-- | :-- |
| 2026-05-30 | 全站业务列表路由统一 keepAlive；独立表单页列表补齐 onActivated；用户/角色/付费结算刷新修复 |
